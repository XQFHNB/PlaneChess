 ...
 * 实现1对多的广播
 */
public class HelperBroascastGroup extends HelperBroadCastBase {
     ...
     *                   0是本机，1是局域网，255是全部
     */
    public HelperBroascastGroup(int port, int timeToLive){
        mPort=port;
        try {
    ...
    public HelperBroascastGroup(int port){
        this(port,1);
    }
    public HelperBroascastGroup(){
        this(30000,1);
    }
