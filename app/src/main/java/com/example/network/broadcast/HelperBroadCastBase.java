 ...
 */
public abstract  class HelperBroadCastBase {

    /**
     * 接收数据的监听器
     */
    protected HelperBroadCastBase.OnReceiveMsgListener mListener;
    protected HelperBroadCastBase.OnNetworkErrorListenr mErrorListner;
